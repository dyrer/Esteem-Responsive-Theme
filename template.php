 ...
 */
function esteem_html_head_alter(&$head_elements) {
 ...
 */
function esteem_breadcrumb($variables) {
 ...
 */
function esteem_preprocess_page(&$variables) {
 ...
 */
function esteem_menu_local_tasks(&$variables) {
  $output = '';
